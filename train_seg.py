...
def main():
    ...
    model = YOLO("/home/dsj/code/ultralytics/apply/ultralytics/cfg/models/11/yolo11-seg.yaml")

    # 2. 开始训练
    results = model.train(
        data="/home/dsj/code/ultralytics/apply/ultralytics/cfg/datasets/labpics_seg.yaml",   # 数据集配置文件路径
        epochs=500,                 # 训练轮数
        ...
        save_period=10,
        resume=False            # 每隔多少 epoch 保存一次权重
    )
